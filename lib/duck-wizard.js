...
var isCommand = function isCommand(value, command) {
...
var INLINE_OPTIONS = Object.freeze({
  INIT: 'init',
  MODULE: ['module', 'm'],
  HELP: ['--help', '--h']
});
var CMD = Object.freeze(objectSpread({}, INLINE_OPTIONS, {
  EXIT: 'exit'
}));
var exec = Object.freeze((_Object$freeze = {}, defineProperty(_Object$freeze, CMD.EXIT, doExit), defineProperty(_Object$freeze, CMD.MODULE, doModules), _Object$freeze));

var launch = function launch() {
  var nbBeforeArgs = 2;
  var argv = process.argv.slice(nbBeforeArgs);
...
var help = function help() {
  var options = Object.values(INLINE_OPTIONS).map(function (o) {
